...
public interface BulletSPI
{
    ...
    //F.eks.: "Service Provider Interface (SPI) for oprettelse af kugleenheder. Dette interface tillader andre moduler (f.eks. Player.test og Enemy) at anmode om oprettelse af en kugle-entitet uden at have en direkte kompileringsafhængighed til den specifikke implementering af en kugle-entitet."
    ...
    //@param launcher: Beskriv launcher parameteren. F.eks.: "Den entitet (f.eks. Player.test eller Enemy), der affyrer kuglen. Dette bruges til at bestemme startposition, retning og eventuelt til at forhindre kollision med affyreren selv i de første øjeblikke."
